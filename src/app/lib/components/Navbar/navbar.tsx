      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex space-x-8">
            {navItems.map((items) => (<a key={items.href} href={items.href} className="hover:opacity-80 transition-opacity duration-200 font-medium text-[#fafafa]" onClick={() => setIsMenuOpen(false)}>{items.label}</a>))}
          </div>

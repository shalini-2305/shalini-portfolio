...
const Hero = () => {
  return (
    <div
      id="home"
      className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center min-h-[calc(100vh-80px)] text-[#18181b]"
    >
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="flex flex-col items-center justify-center gap-4">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 animate-fade-in-up delay-100 text-[#fafafa]">
            Hi, I'm <span className="text-[#fafafa]">Shalini M</span>
          </h1>
          <p className="text-xl sm:text-2xl mb-6 animate-fade-in-up delay-200 text-[#fafafa]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 animate-fade-in-up delay-400">
          ...
          <button className="px-6 py-3 rounded-lg bg-transparent hover:opacity-80 transition-opacity border flex items-center border-[#fafafa] text-[#fafafa]">
